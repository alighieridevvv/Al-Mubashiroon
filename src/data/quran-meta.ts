...
export const ALL_SURAHS: Surah[] = [
  ...
  { number: 3, name: "آل عمران", englishName: "Al-Imran", englishNameTranslation: "The Family of Imraan", numberOfAyahs: 200, revelationType: "Medinan" },
  ...
  { number: 46, name: "الأحقاف", englishName: "Al-Ahqaf", englishNameTranslation: "The Wind-Sanded Hills", numberOfAyahs: 35, revelationType: "Meccan" },
  ...
  { number: 51, name: "الذاريات", englishName: "Adh-Dhariyat", englishNameTranslation: "The Wind that Scatter", numberOfAyahs: 60, revelationType: "Meccan" },
  ...
  { number: 60, name: "الممتحنة", englishName: "Al-Mumtahanah", englishNameTranslation: "The Examining", numberOfAyahs: 13, revelationType: "Medinan" },
  ...
  { number: 96, name: "العلق", englishName: "Al-Alaq", englishNameTranslation: "The Cling", numberOfAyahs: 19, revelationType: "Meccan" },
...
export function getJuzForSurahAndAyah(surah: number, ayah: number): number {
  // Simple approximation or mapping for Juz bounds
  // Standard Juz bounds for a few key Surahs or a fallback
  if (surah === 1) return 1;
  if (surah === 2) {
  ...
  if (surah <= 5) return 6;
  if (surah <= 9) return 10;
  if (surah <= 14) return 13;
  if (surah <= 17) return 15;
  if (surah <= 20) return 16;
  if (surah <= 24) return 18;
  if (surah <= 28) return 20;
  if (surah <= 34) return 22;
  if (surah <= 39) return 24;
  if (surah <= 45) return 25;
  if (surah <= 57) return 27;
  if (surah <= 77) return 29;
  return 30;
}
